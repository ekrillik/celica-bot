...
class Builds(commands.Cog):
    ...
    async def cnteams(self, ctx: commands.Context):
        embed = discord.Embed(title="", description="")
        embed.set_image(url='https://pgr-discord-bot.s3.ap-southeast-2.amazonaws.com/Infographics/CN+Teams_v6.png')
        await ctx.send(embed=embed)
    ...
    async def glbteams(self, ctx: commands.Context):
        embed = discord.Embed(title="", description="")
        embed.set_image(url='https://pgr-discord-bot.s3.ap-southeast-2.amazonaws.com/Infographics/GLB+Teams_v3.png')
        await ctx.send(embed=embed)
    ...
    async def affixmechs(self, ctx: commands.Context):
        embed = discord.Embed(title="", description="")
